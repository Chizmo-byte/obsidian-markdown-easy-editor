...
- Strips AI-generated intro phrases (e.g. "承知しました、以下に...")
...
1. Download `main.js`, `manifest.json` (and `styles.css` if present) from the [latest release](https://github.com/Chizmo-byte/markdown-easy-editor/releases)
